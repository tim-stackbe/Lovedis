...
\restrict g432OTtXjoQNqMpP6YS9fj9JSJmhV6uZW6BGhfOP5f5WOD5rp3ZXnRXhOn1bsFO
...
CREATE TABLE public."Program" (
    ...
    "contactPerson" text,
    "fixCreditCost" integer DEFAULT 0 NOT NULL,
    "sessionDate" text
);
...
COPY public."Program" (id, title, summary, description, "focusTags", status, "sortOrder", "createdById", "createdAt", "updatedAt", "contactPerson", "fixCreditCost", "sessionDate") FROM stdin;
bc4258a9-9c0e-4572-9a83-30a1c39583f9	Workshop 1: KI Trends & Modellvergleich	Gemeinsamer 2h-Einstieg für alle Startups: Markttrends, Modellvergleich und Cloud vs. On-Prem.	Gemeinsamer 2h-Workshop für alle Startups im Batch. Follow-ups mit Effizienzanalyse können individuell gebucht werden.\n\nDer Einstieg schafft einen gemeinsamen Wissensstand. Tim gibt einen Überblick über den aktuellen Stand der KI-Entwicklung: Was bewegt den Markt, welche Modelle setzen sich durch, wohin geht die Entwicklung in den nächsten 12 bis 24 Monaten.\n\nIm zweiten Teil steht der Modellvergleich im Mittelpunkt. Die Startups analysieren gemeinsam, welche Modelle sie selbst einsetzen oder evaluieren, und stellen diese gegenüber: Leistung, Kosten, Einsatzbereich und On-Premise-Fähigkeit. Mittelständische Unternehmenskunden stellen die On-Prem-Anforderung regelmäßig — deshalb werden Vor- und Nachteile von Cloud- vs. On-Prem-Lösungen direkt an konkreten Modellen durchgespielt. Ein zentrales Thema: Durch den Wechsel auf ein alternatives Modell lassen sich in vielen Fällen erhebliche Kosten einsparen, ohne Leistungseinbußen hinnehmen zu müssen.\n\nOutput: Startups kennen die relevanten Markttrends, sind auf dem gleichen Wissenstand, können ihre Modellwahl kritisch einordnen und wissen, wo Optimierungspotenzial bei Kosten und Infrastruktur liegt.\n\nFormat: Gemeinsamer Online-Workshop (2h). Anbieter: LOVEDIS.	{AI,"Product & Tech",Workshop}	OPEN	5	co4u0v4vuya2gzgkcr8qggc9w	2026-09-11 11:17:21.283	2026-09-14 10:38:22.358	Tim Meggert	0	\N
7586ed36-a091-4b07-bd17-789f96919e76	Community / Ökosystem Sales	Online Workshop zu Community- und Ökosystem-Vertrieb.	Session im Rahmen von Sales, Pricing & Growth: Community / Ökosystem Sales mit unusual business (Sina Wans). Format: Online Workshop.	{Sales,Growth,GTM}	OPEN	1	co4u0v4vuya2gzgkcr8qggc9w	2026-09-11 10:26:08.021	2026-09-11 10:26:08.021	Sina Wans	0	\N
b3c1b388-929f-4c50-9a8d-7a132eed4472	Aufbau strukturierter Pipelines	Online Workshop zum Aufbau strukturierter Sales-Pipelines.	Session im Rahmen von Sales, Pricing & Growth: Aufbau strukturierter Pipelines mit GAL Digital (Tobias Auradniczek). Format: Online Workshop.	{Sales,Pipeline,GTM}	OPEN	2	co4u0v4vuya2gzgkcr8qggc9w	2026-09-11 10:26:08.021	2026-09-11 10:26:08.021	Tobias Auradniczek	0	\N
06326b66-fce5-4c5f-bae5-cc7de3f046f8	Nightmare Competitor	Live Workshop zu Wettbewerbspositionierung.	Session im Rahmen von Sales, Pricing & Growth: Nightmare Competitor mit Uni Marburg / StartMiUp (Michael Stephan). Format: Live Workshop.	{Sales,Positioning,Growth}	OPEN	3	co4u0v4vuya2gzgkcr8qggc9w	2026-09-11 10:26:08.021	2026-09-11 10:26:08.021	Michael Stephan	0	\N
ac850056-72cc-4499-84ce-ef55da9c2191	SaaS Contracting	Online Workshop zu SaaS-Vertragsgestaltung im Sales-Kontext.	Session im Rahmen von Sales, Pricing & Growth: SaaS Contracting mit Aulinger Rechtsanwälte Notare (Dr. Ralf Heine). Format: Online Workshop.	{Sales,Legal,SaaS}	OPEN	4	co4u0v4vuya2gzgkcr8qggc9w	2026-09-11 10:26:08.021	2026-09-11 10:26:08.021	Dr. Ralf Heine	0	23. September, 10–12 Uhr
cmu140syl00007gp5ssi33b5t	Sales, Pricing & Growth	Exklusives Programm rund um Vertrieb, Pricing und skalierbares Wachstum — 6 fixe Credits, du musst dich nur anmelden.	Das exklusive LOVEDIS-Programm rund um Sales, Pricing & Growth. Von den 12 Venture Credits sind 6 fix für diese Journey verplant — du musst sie nicht einlösen, sondern dich nur offiziell anmelden.\n\nSession „Sales Foundations: People, Process & Tools — ein Framework für skalierbares GTM“: Online Workshop, 90 Min., Q&A bei Bedarf.\n\nProgrammziele: geschärfte Value Proposition & ICP, ein Sales Handbook (Pipeline, GtM, Playbook, Deal Qualification, Skalierung) sowie eine Pricing-Strategie mit validiertem Pricing-Modell.	{Sales,Pricing,Growth,GTM}	DRAFT	1	usr_a774a28183522b57c2f3	2026-09-14 10:38:22.365	2026-09-14 10:58:27.872	Claudia Proß	6	Input-Session am 27. August, 12:00–13:30 Uhr
\.
...
--
-- Name: Program Program_createdById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Program"
    ADD CONSTRAINT "Program_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict g432OTtXjoQNqMpP6YS9fj9JSJmhV6uZW6BGhfOP5f5WOD5rp3ZXnRXhOn1bsFO
